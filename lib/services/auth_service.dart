...
import 'package:poultry/services/storage_services.dart';

//TODO: If you want to get the user ID, use AuthProvider.of(context).auth.getCurrentUID();
...
//GET USER
  ...
  // Sign Out
  signOut() {
    FirebaseServices().updateLastLogout(
      _firebaseAuth.currentUser.uid,
    );

    FirebaseServices().removeFCMToken(
      _firebaseAuth.currentUser.uid,
    );
